...
const LoginPage = () => {
  ...
  toast.error(result.message || "Login/Signup failed. Please try again.");
}
            ...
            <form onSubmit={onSubmitHandler} className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
                ...
                </h2>
                {
                    currentState === "Sign up" && !isDataSubmitted && (
                        ...
                        <input onChange={(e) => setFullName(e.target.value)} type="text" className='p-2 border border-gray-500 rounded-md focus:outline-none' placeholder='Full Name' required />
                    )
                }
                ...
                <div className='flex items-center gap-2 text-sm text-gray-500'>
                    <input type="checkbox" />
                    <p>Agree to the terms o fuse & privacy policy.</p>
                </div>
